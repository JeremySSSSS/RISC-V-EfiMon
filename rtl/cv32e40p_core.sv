...
#(
  ...
  logic        [1:0]  cat_inc [CATEGORY_COUNT];
  logic               cat_divcyc_inc;
  ...
  cv32e40p_insn_classifier insn_classifier_i (
      ...
      .inc_o          (cat_inc),
      .divcyc_inc_o   (cat_divcyc_inc)
  );

  cv32e40p_category_counter_bank category_counter_bank_i (
      .clk_i          (clk),
      .rst_ni         (rst_ni),
      .inc_i          (cat_inc),
  ...
  cv32e40p_csr_rdata_mux csr_rdata_mux_i (
      .category_hit_i   (cat_csr_hit),
      .category_rdata_i (cat_csr_rdata),
      .standard_rdata_i (csr_rdata_cs),
      .rdata_o          (csr_rdata)
  );
